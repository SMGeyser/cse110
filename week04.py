...
b = 45
# new
print(f'This is a string with f-string formatting... {a + 5 * 23 - 12:.4f} {b} {"nice":&>10}')
# old
...
# print(f'here\'s another example: {a:*^10.4f} and {b:#^20}')
# print()
...
#### that I need to use? (see top of code)
# x = 10 ** .5
# print(x)
# print()
